...
namespace Escalon
{
    public class ProjectTemplate
    {
        public class SaveProjectAsTemplateEditorWindow : EditorWindow
        {
            ...
            [MenuItem("Window/Project Templates/Save Project As Template")]
            ...
            private void DeleteTemplateFolders()
            {
                ...
                {
                    UnityEngine.Debug.LogErrorFormat("Failed to delete template folders, exception: {0}", e.Message);
                }
            }
            ...
            private void InvokeSaveProjectAsTemplate()
            {
                ...
                MethodInfo methodInfo = editorUtilityType.GetMethod("SaveProjectAsTemplate",
                    BindingFlags.Static | BindingFlags.NonPublic);
                methodInfo.Invoke(editorUtilityType,
                    new object[]
                    {
                        targetPath, templateName, templateDisplayName, templateDescription, templateDefaultScene,
                        templateVersion
                    });
            }
            ...
            private void SetDefaultSceneAssetFromPath()
            {
                if (templateDefaultScene != String.Empty)
                {
                    ...
                    UnityEngine.Debug.AssertFormat(templateDefaultSceneAsset != null,
                        "Failed to load scene asset at path from package.json, path: {0}", templateDefaultScene);
                }
                else
                {
            ...
            {
                templateDefaultSceneAsset = (SceneAsset)EditorGUILayout.ObjectField("Default scene asset:",
                    templateDefaultSceneAsset, typeof(SceneAsset), false);
            ...
            private void OnGUI()
            {
                ...
                {
                    targetPath = EditorUtility.SaveFolderPanel("Choose target folder",
                        UnityEditorApplicationProjectTemplatesPath, String.Empty);
...
#pragma warning restore 0649
        ...
        [MenuItem("Window/Project Templates/Unity Project Template Window")]
        private static void ShowWindow()
        {
            ...
            MethodInfo methodInfo =
                projectTemplateWindowType.GetMethod("SaveAsTemplate", BindingFlags.Static | BindingFlags.NonPublic);
