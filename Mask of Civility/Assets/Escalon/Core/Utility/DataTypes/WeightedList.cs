//Adapted from https://github.com/cdanek/KaimiraWeightedList
...
namespace Escalon
{
    ...
    {
        /// <summary>
        /// Create a new WeightedList with an optional System.RandomValue.
        /// </summary>
        ...
        /// <summary>
        /// Create a WeightedList with the provided items and an optional System.RandomValue.
        /// </summary>
        ...
        /// Create a WeightedList with the provided items and an optional System.RandomValue.
        /// </summary>
        public WeightedList(ICollection<T> listItems, Random rand = null, int startWeight = 0)
        {
            _rand = rand ?? new Random();
            foreach (T item in listItems)
            {
                _list.Add(item);
                _weights.Add(startWeight);
            }
...
#pragma warning restore S125 // Sections of code should not be commented out
        ...
        private int FixWeight(int weight) => (BadWeightErrorHandling == WeightErrorHandlingType.ThrowExceptionOnAdd)
